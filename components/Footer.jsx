  ...
  return (
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center space-y-8 md:space-y-0 md:grid md:grid-cols-4 md:gap-8">
          ...
          <div className="w-full max-w-4xl grid grid-cols-2 sm:grid-cols-2 gap-8 md:col-span-2 text-center">
            <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-400">
          <p>
            Copyright © {currentYear} FloriddaSoftware. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
